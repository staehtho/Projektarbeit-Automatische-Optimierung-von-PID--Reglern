...
def main():
    ...
    with MatlabInterface() as mat:
        ...
        mat.run_simulation("closedloop_model_limit", "yout", stop_time=20, max_step=0.001)
        t_mat = mat.t
    ...
    # Closed Loop Python
    # **************************************************************
    t_py, y_py = pid.step_response(t0=0, t1=20, dt=0.01, method="Radau", anti_windup=True)
