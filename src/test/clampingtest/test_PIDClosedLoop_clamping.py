...
def test_system_response():
    ...
    test_param = {
        ...
        "pt2": {
            "num": [1], "den": [1, 2, 1], "Kp": 10, "Ti": 3, "Td": 0.3, "itae_ref": 1.0359858615494895
        },
        "pt3": {
            "num": [1], "den": [1, 3, 3, 1], "Kp": 10, "Ti": 3, "Td": 0.3, "itae_ref": 7.035901384691645
        },
        "pt4": {
            "num": [1], "den": [1, 4, 6, 4, 1], "Kp": 10, "Ti": 3, "Td": 0.3, "itae_ref": 43.17782183855724
        },
        "pt5": {
            "num": [1], "den": [1, 5, 10, 10, 5, 1], "Kp": 10, "Ti": 3, "Td": 0.3, "itae_ref": 68.69236846487661
        }
    }
